...
export const SIDEBAR_CONFIG: MenuItem[] = [
  ...
  { label: 'Mis Solicitudes', route: '/solicitudes', icon: 'airplane_ticket', category: 'Viajes', requiredAnyPermissions: ['travel:view', 'travel:create'] },
  ...
  { label: 'Comprobar Gastos', route: '/comprobar-gastos', icon: 'receipt', category: 'Gastos', requiredAnyPermissions: ['receipts:view', 'receipts:create', 'receipts:approve'] },
  { label: 'Reembolsos', route: '/reembolsos', icon: 'currency_exchange', category: 'Gastos', requiredAnyPermissions: ['refunds:request', 'refunds:approve'] },
  ...
  { label: 'Roles', route: '/roles', icon: 'admin_panel_settings', category: 'Gestión', requiredAnyPermissions: ['users:edit'] },
  { label: 'Reglas de Autorización', route: '/reglas-autorizacion', icon: 'gavel', category: 'Gestión', requiredAnyPermissions: ['users:edit'] },
  { label: 'Políticas de Reembolsos', route: '/politicas-reembolso', icon: 'receipt_long', category: 'Gestión', requiredAnyPermissions: ['users:edit'] },
  ...
  { label: 'Sociedades', route: '/sociedades', icon: 'domain', category: 'Control Global', requiredAnyPermissions: ['superadmin:manage_groups'] },

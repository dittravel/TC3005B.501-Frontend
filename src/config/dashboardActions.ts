...
export const DASHBOARD_ACTION_CATALOG: DashboardActionDefinition[] = [
  ...
  { label: 'Comprobar Gastos', route: '/comprobar-gastos', iconKey: 'comprobar', description: 'Adjunta comprobantes de gastos', requiredAnyPermissions: ['receipts:create'], defaultPriority: 45 },
  { label: 'Reembolsos', route: '/reembolsos', iconKey: 'reembolsos', description: 'Consulta el estado de tus reembolsos', requiredAnyPermissions: ['travel:create'], defaultPriority: 50 },
  { label: 'Cotizaciones', route: '/cotizaciones', iconKey: 'cotizaciones', description: 'Gestiona solicitudes por cotizar', requiredAnyPermissions: ['travel:def_amount'], defaultPriority: 55 },
  ...
  { label: 'Atenciones', route: '/atenciones', iconKey: 'atenciones', description: 'Atiende solicitudes de viaje asignadas', requiredAllPermissions: ['travel:view_flights', 'travel:view_hotels'], defaultPriority: 65 },
  { label: 'Sociedades', route: '/sociedades', iconKey: 'sociedades', description: 'Consulta sociedades y su configuración', requiredAnyPermissions: ['superadmin:manage_groups', 'societies:view'], defaultPriority: 70 },

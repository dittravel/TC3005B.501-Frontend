...
export default function CreateAuthRuleForm() {
    ...
    async function handleSubmit() {
        // TO-DO: REEMPLAZAR CON EL ENDPOINT REAL CUANDO ESTÉ LISTO :)
        const payload = {
            niveles,
            automatico,
            autorizadores,
        ...
        // AQUI VA LA LÓGICA PARA ENVIAR TODO AL BACK :)
    }

    return (
        <div className="space-y-6 mt-6">

            {/* Seccion 1: Niveles de autorización */}
            <div className="card">
            ...
            <div className="flex justify-end gap-2">
                <Button variant="border" color="primary" href="/reglas-autorizacion">
                    Cancelar
                </Button>
